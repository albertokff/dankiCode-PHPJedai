          ...
          <div class="col-md-6">
            <div class="equipe-single">
              <div class="row">
                ...
                <div class="col-md-10">
                  <h3>Diogo Alberto</h3>
                  <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Quis lectus nulla at volutpat diam. Adipiscing at in tellus integer feugiat scelerisque.</p>
                </div>
              </div>
            </div>
          </div>
